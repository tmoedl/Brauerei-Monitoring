 ...
 * auf glatte Werte (1/2/5 * 10^n), damit Beschriftungen wie "20 °C" statt
 * krummer Zwischenwerte wie "17.9 °C" erscheinen.
 */
...
export class WallPanel3D {
    ...
    _drawChart(top, availH) {
        ...
        const { min: yMin, max: yMax, ticks } = niceTicks(rawMin - yPad, rawMax + yPad, 5);
