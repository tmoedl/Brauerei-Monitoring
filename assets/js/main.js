...
import { Scene }         from './Scene.js?v=1780065605';
import { BreweryModel }  from './BreweryModel.js?v=1780065605';
import { WallDisplay }   from './WallDisplay.js?v=1780065605';
import { WallPanel3D }   from './WallPanel3D.js?v=1780065605';
import { SettingsPanel } from './SettingsPanel.js?v=1780065605';
import { dataService }   from './dataService.js?v=1780065605';
...
async function boot() {
    ...
    const onPanelClose = () => {
        ...
        if (settings.settings.showTempBars) bars3D?.show();
    };
    ...
    settings.on('settingChange', (key, val) => {
        ...
        if (key === 'showTempBars')    val ? bars3D?.show() : bars3D?.hide();
    ...
    //Balkendiagramm, Soll-Marker und Labels immer sichtbar starten
    bars3D?.show();
